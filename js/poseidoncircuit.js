...
describe("Poseidon Circuit js", function () {
    let poseidon;
    let F;
    let circuit6;
    let circuit3;
    ...
    before( async () => {
        ...
        F = poseidon.F;
        circuit6 = await wasm_tester(path.join(__dirname, "poseidon6_test.circom"));
        circuit3 = await wasm_tester(path.join(__dirname, "poseidon3_test.circom"));
        circuitEx = await wasm_tester(path.join(__dirname, "poseidonex_test.circom"));
    });
